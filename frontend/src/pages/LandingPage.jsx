      ...
      <section className="pb-11">
        ...
        <div className="flex justify-evenly mt-10">
          <Features
            logo={layoff}
            title={"Layoff Trends"}
            description1={"Track and analyze layoffs"}
            description2={"across various industries."}
          ></Features>
          <Features
            logo={comparsion}
            title={"Company Comparisons"}
            description1={"See how different companies"}
            description2={"handle layoffs."}
          ></Features>
          <Features
            logo={resources}
            title={"Resources & Support"}
            description1={"Find job resources,"}
            description2={"resume tips, and more."}
          ></Features>
          <Features
            logo={community}
            title={"Community Forum"}
            description1={"Connect with others,"}
            description2={"share experiences and support."}
          ></Features>
        </div>
      </section>
